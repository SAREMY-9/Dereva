					...
					<div class="col-md-6 col-lg-5">
						<div class="login-box bg-white box-shadow border-radius-10">
							<div class="login-title">
								<h2 class="text-center text-success">BOOK FOR DEREVA</h2>
							</div>


							
               <!----Driver's test booking form ---->



			   
                            
							<form action="{{route('bookingTest')}}" method="POST"> 
                                ...
                                <div class="input-group custom">
                                    <h6 class="form-control form-control-lg" >Select....</h6>
                                    <select name="class" autocomplete="class" class="form-control form-control-lg">
